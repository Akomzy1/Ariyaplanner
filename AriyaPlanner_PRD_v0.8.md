# AriyaPlanner — Product Requirements Document v0.8

**Product:** AriyaPlanner — the AI event planner for Nigerian families
**Company:** AkomzyAi Consulting Ltd
**Date:** 10 June 2026
**Status:** Draft v0.8 (v0.6: PWA-first · v0.7: §11a Adjacent Verticals deferred · v0.8: F2a plan editing + member suggestion→approval flow, ritual-content guardrail, estimate-pending items, suggestion_gap signal)
